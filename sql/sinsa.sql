...
-- ORDER_PRODUCTS --
CREATE TABLE SINSA.ORDER_PRODUCTS (
                                      ID BIGINT NOT NULL,
                                      ORDER_ID BIGINT NOT NULL,
...
CREATE INDEX IDX_ORDER_PRODUCTS_ORDER_ID ON SINSA.ORDER_PRODUCTS USING BTREE(ORDER_ID ASC);
CREATE INDEX IDX_ORDER_PRODUCTS_PRODUCT ON SINSA.ORDER_PRODUCTS USING BTREE(PRODUCT ASC);
CREATE INDEX IDX_ORDER_PRODUCTS_STATUS ON SINSA.ORDER_PRODUCTS USING BTREE(STATUS ASC);
CREATE INDEX IDX_ORDER_PRODUCTS_CREATED ON SINSA.ORDER_PRODUCTS USING BTREE(CREATED DESC);
CREATE INDEX IDX_ORDER_PRODUCTS_UPDATED ON SINSA.ORDER_PRODUCTS USING BTREE(UPDATED DESC);

COMMENT ON TABLE SINSA.ORDER_PRODUCTS IS '주문 상품';
COMMENT ON COLUMN SINSA.ORDER_PRODUCTS.ID IS '아이디';
COMMENT ON COLUMN SINSA.ORDER_PRODUCTS.ORDER_ID IS '주문 번호';
COMMENT ON COLUMN SINSA.ORDER_PRODUCTS.PRODUCT IS '상품 번호';
COMMENT ON COLUMN SINSA.ORDER_PRODUCTS.QUANTITY IS '주문 상품 수량';
COMMENT ON COLUMN SINSA.ORDER_PRODUCTS.PRICE IS '주문 상품 가격';
COMMENT ON COLUMN SINSA.ORDER_PRODUCTS.STATUS IS '주문 상품 상태';
COMMENT ON COLUMN SINSA.ORDER_PRODUCTS.CREATED IS '등록일';
COMMENT ON COLUMN SINSA.ORDER_PRODUCTS.UPDATED IS '변경일';
